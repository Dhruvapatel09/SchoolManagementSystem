<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherRegistration.aspx.cs" Inherits="SchoolManagementSyatem.TeacherRegistration" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 bg-light position-relative">
                    <div class="login d-flex align-items-center py-3">
                        <a href="TeacherLogin.aspx" class="btn btn-outline-secondary register-link">Login here</a>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 col-xl-7 mx-auto">
                                    <div class="login-form">
                                        <h3 class="display-4 pb-3">Teacher Sign Up</h3>
                                        <p class="text-muted mb-3">Sign page for Teachers.</p>

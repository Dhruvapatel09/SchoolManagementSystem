...
namespace SchoolManagementSyatem
{
    public partial class TeacherRegistration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            // Save teacher's information to the database
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    // Example query to insert the teacher's information into the Teachers table
                    string query = "INSERT INTO TeacherRegistration (Name, Email, Password, PasswordConfirmed) VALUES (@Name, @Email, @Password, @PasswordConfirmed)";
                ...
                // Redirect the teacher to a confirmation page or login page
        ...
        private bool IsEmailExists(string email)
        {
            ...
            // SqlCommand command = new SqlCommand("SELECT COUNT(*) FROM Teachers WHERE Email = @Email", connection);
            // command.Parameters.AddWithValue("@Email", email);
